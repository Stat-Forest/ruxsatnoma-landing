...
const homeKeys = {
  ...
  uz_cyrl: {
    ...
    'home.seasons.status': 'Ҳолат',
    'home.seasons.disclaimer': 'Намуна жадвал. Мавсум ойлари Агентлик томонидан тасдиқланади ва минтақага қараб фарқ қилиши мумкин — тасдиқлангач, якуний саналар шу ерда кўринади.'
  },
  kaa: {
  ...
  ru: {
    ...
    'home.seasons.status': 'Статус',
    'home.seasons.disclaimer': 'Примерный график. Месяцы сезона утверждаются Агентством и могут отличаться в зависимости от региона — окончательные даты появятся здесь после утверждения.'
  },
  en: {
    ...
    'home.seasons.status': 'Status',
    'home.seasons.disclaimer': 'Sample schedule. Season months are confirmed by the Agency and may differ by region — the final dates will appear here once approved.'
  }
};
