...
export const common = {
  ...
  'hero.badge': 'Ózbekstan Respublikası Orman Xojalıǵı Mámleketlik Sisteması',
  'hero.title': 'Orman fondı jerlerinen paydalanıw ushın',
  'hero.titleAccent': 'Elektron Ruxsatnama',
  'hero.subtitle':
