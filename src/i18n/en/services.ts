/** ServicesPage — English copy. */
export const services = {
  'services.badge': 'State Services Registry',
  ...
  'services.card.termLabel': 'Validity:',
  'services.card.daysUnit': 'days',
  'services.card.apply': 'Apply',

  'services.empty': 'No services available yet.',
  'services.error.title': 'Failed to load services',
  'services.error.text': 'Please try refreshing the page later.',
} as const;
